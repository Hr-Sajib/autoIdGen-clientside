    ...
    <Card className="bg-background border-border">
      <CardHeader>
        <div className="flex items-center justify-between">
          <CardTitle className="text-xl font-semibold text-foreground">All Project</CardTitle>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b-2 border-b-blue-600 border-border">
                ...
                <th className="text-left py-3 px-4 font-medium text-muted-foreground">Card Type</th>
                <th className="text-left py-3 px-4 font-medium text-muted-foreground">Total Card</th>
                <th className="text-left py-3 px-4 font-medium text-muted-foreground">Batch Code</th>

...
//   return (
//     <div
//       className="relative calibri  w-[644px] h-[1019px] rounded-lg overflow-hidden font-sans"
//       style={{
...
//             />
//           )}
//           <p className="mt-4 text-center text-[26px] font-bold text-white max-w-[520px]">
//             {instituteName}
//           </p>
...
//         {/* Student Name */}
//         <p className="absolute top-[570px] w-full text-center text-[36px] font-bold text-blue-700">
//           {studentName}
//         </p>

//         {/* Student Info */}
//         <div className="absolute top-[635px] left-[140px] w-[460px] text-[20px] text-black flex gap-4">
...
//         {/* Principal Signature */}
//         {signatureUrl && (
//           <div className="absolute bottom-[50px] right-[16px] text-center">
//             <Image
//               src={signatureUrl}
//               alt="Signature"
//               width={80}
...
//         {/* ID Type */}
//         <p className="absolute bottom-[30px] left-[12px] rounded border border-gray-500 px-2 py-[3px] text-[20px] text-gray-300 font-sans">
//           {idCardType} ID
//         </p>
//       </div>
//     </div>

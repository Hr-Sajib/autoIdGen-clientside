...
// export default function InstituteTemplateSetupPage() {
//   const [isModalOpen, setIsModalOpen] = useState(false)
//   const [cardOrientation, setCardOrientation] = useState("horizontal") // Retrieved from previous page
//   const [formData, setFormData] = useState({
//     department: "",
//     rollNumber: "",
//     bloodGroup: "",
...
//   // Retrieve card orientation from previous page selection
//   useEffect(() => {
...
//                       // Show Employee Card for Vertical Layout
//                       <EmployeeCard
...
//                       />
//                     ) : (
//                       // Show Student Card for Horizontal Layout
//                       <StudentCard
//                         instituteName={formData.instituteName}
//                         address={formData.address}
//                         idCardType={formData.idCardType}

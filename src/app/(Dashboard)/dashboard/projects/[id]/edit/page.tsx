...
// import { LucideEdit, Trash2, Loader2, LucideDownload, Search, RefreshCw, Download } from "lucide-react"
...
//               variant="outline"
//               className="w-auto bg-[#4A61E4] hover:bg-blue-600 text-white text-sm sm:text-base px-3 sm:px-4 py-1 sm:py-2"
//             >
//               <span><Download className="w-4 h-4 mr-1" /></span>
//               Bulk Export
//             </Button>
//           </div>
//         </div>
...
// import { EditProject } from "../../_components/EditProject"
// import Image from "next/image"
// import { downloadBulkExportWithProgress } from "@/utils/bulkExport"
// import Loading from "@/app/loading"
// import ExportLoading from "../../../_components/ExportLoading"
// import Link from "next/link"
// import UserQRCode from "@/components/layout/UserQRCode"
...
//     try {
//       await downloadBulkExportWithProgress(project.batchId, (progress) => {
...
//               variant="outline"
//               disabled={loading}
//               className="w-auto bg-[#4A61E4] hover:bg-blue-600 text-white text-sm sm:text-base px-3 sm:px-4 py-1 sm:py-2 disabled:bg-gray-400 disabled:cursor-not-allowed"
//             >
//               <span><Download className="w-4 h-4 mr-1" /></span>
...
//         {/* ✅ NEW: Progress Bar - শুধু export চলার সময় দেখাবে */}
//         {loading && (
...
//               <div 
//                 className="bg-gradient-to-r from-blue-500 to-blue-600 h-full rounded-full transition-all duration-300 ease-out shadow-sm"
...
export default function ViewDetailsPage() {
  ...
  if (projectLoading) return <Loading />
  if (projectError) return <div className="p-4 sm:p-6 text-red-500 text-center text-sm sm:text-base">Failed to load project</div>
  if (loading) return <ExportLoading progress={exportProgress} />

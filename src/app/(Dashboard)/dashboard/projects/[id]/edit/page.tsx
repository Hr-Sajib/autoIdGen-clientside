...
// //   });
// //   // console.log( "bal bal bal bal bal bal bal",     cardData);
...
// //                here you have to show the unfilled cards count 
// //               </div>
// //               <div className="bg-red-500 p-5"> {project.cardQuantity} </div>
// //               bellow you have to show generated cards count 
// //               <div className="bg-red-500 p-5"> {project.cardQuantity} </div>
             
// //               bellow you have to show processing count
// //               <div className="bg-red-500 p-5"> {project.cardQuantity} </div>
...
//         {/* Desktop: Table Layout */}
//         <div className="hidden sm:block rounded-xl border border-gray-100 shadow-sm bg-white">
//           <table className=" text-left overflow-x-scroll  text-gray-700">
//             <thead className="bg-gray-100 sticky top-0 z-10">
//               <tr>
//                 <th className="px-4 py-3 border-b text-sm font-semibold text-muted-foreground">Sr.</th>
//                 <th className="px-4 py-3 border-b text-sm font-semibold text-muted-foreground">Batch</th>

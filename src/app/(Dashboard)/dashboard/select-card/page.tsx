  ...
  const cardTypes = [
    {
      ...
      image: "/student-id-card-template-with-photo-placeholder.jpg",
    },
    {
      id: "employee",
      title: "Employee ID Card",
      image: "/employee-id-card-template-with-photo-placeholder.jpg",
    },
  ]
      ...
      <main className="container mx-auto px-6 py-8">
        ...
        {selectedCard && (
          <div className="flex justify-center mt-8">
            <Button className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-2">Continue</Button>
          </div>
        )}
      </main>

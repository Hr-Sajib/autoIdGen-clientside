...
//           <h1 className="text-xl lg:hidden text-center bg-blue-500 p-4 rounded-lg text-white sm:text-2xl font-bold text-gray-900 mb-4">
...
//                     idCardType={form.idCardType || "ID Card"}
//                     employeeName="Name"
//                     department="CSE"
//                     employeeId="1233"
//                     bloodGroup="B+"
...
export default function InstituteTemplateSetupPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        <div className="max-w-full mx-auto">
          <h1 className="text-xl lg:hidden text-center bg-blue-500 p-4 rounded-lg text-white sm:text-2xl font-bold lg:text-gray-900 mb-4">
                Template Setup
              </h1>
          <div className="flex flex-col-reverse gap-10  lg:flex-row lg:gap-8">
            {/* Left Form Section */}
